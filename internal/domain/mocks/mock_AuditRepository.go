...
// MockAuditRepository_Record_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Record'
type MockAuditRepository_Record_Call struct {
	*mock.Call
}
