...
func New(reg prometheus.Registerer) *Metrics {
	m := &Metrics{
		...
		SSEConnections: prometheus.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: "flowforge", Name: "sse_connections_active",
			Help: "Active SSE connections, per tenant.",
		}, []string{"tenant_id"}),
		EventsPublished: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "flowforge", Name: "events_published_total",
			Help: "Real-time events published, per tenant and event type.",
